...
-- Générée le: 2025-07-13 14:15:56
-- Usage: psql -d petparadise -f petparadise_backup_2025-07-13_14-15-55.sql
...
INSERT INTO users (username, password) VALUES ('admin', '$2y$10$ArpF93iuMQOGO8F.Ff3SzulKdbnrezwIC8pTESVjImDVLu1WJ1xBO') ON CONFLICT (username) DO NOTHING;
